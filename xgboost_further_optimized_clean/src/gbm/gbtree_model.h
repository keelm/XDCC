...
struct GBTreeModelParam : public dmlc::Parameter<GBTreeModelParam> {
  ...
  int num_feature;
  /*! \brief number of labels to be used by trees */
  int num_label;
  ...
  GBTreeModelParam() {
    ...
    static_assert(sizeof(GBTreeModelParam) == (4 + 2 + 2 + 32 + 2) * sizeof(int),
  ...
  DMLC_DECLARE_PARAMETER(GBTreeModelParam) {
    ...
    DMLC_DECLARE_FIELD(num_label)
        .set_lower_bound(0)
        .describe("Number of labels used for training and prediction.");
